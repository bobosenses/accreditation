...
@Service("tSStaffGroupService")
@Transactional
public class TSStaffGroupServiceImpl extends CommonServiceImpl implements TSStaffGroupServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TSStaffGroupEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(TSStaffGroupEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(TSStaffGroupEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(TSStaffGroupEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TSStaffGroupEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("t_s_staff_group",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
